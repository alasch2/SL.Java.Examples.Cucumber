...
public class BasicTestEventsSteps {
    ...
    public void a_test_that_should_pass() {
    }
    ...
    public void a_test_that_should_fail() {
    }

    @When("try run the failing test")
    public void i_run_failing_test() {
    }
    ...
    public void a_test_that_should_be_skipped_by_TIA() {
    }
    
    @When("try run the test that should pass")
    public void i_run_test_that_should_run() {
    }
    ...
    public void a_test_that_should_be_skipped() {
    }

    @When("try run the skipped test")
    public void i_run_skipped_test() {
    }
