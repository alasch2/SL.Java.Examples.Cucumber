...
public class BasicTestEventsSteps {
	...
	public void try_run_the_example() throws Throwable {
	}

	@Then("^it also should pass$")
	public void it_also_should_pass() throws Throwable {
	}
	
	
	@When("^try run the example that should be skipped by TIA$")
	public void try_run_the_example_that_should_be_skipped_by_TIA() throws Throwable {
	}

	@Then("^it should be also skipped by TIA$")
	public void it_should_be_also_skipped_by_TIA() throws Throwable {
	}
}
